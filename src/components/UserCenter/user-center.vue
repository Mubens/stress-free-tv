  ...
  <div class="user-center">
    ...
    <div class="user-signin" v-if="isLogin">
      ...
      >
        <a class="user-face" href="#">
          <img v-lazy="$store.state.user_face" />
        </a>
        <div
          class="vp-tool"
    ...
    <div class="user-logout" v-else>
      <div class="logout-face">
        <a href="/login">
          <img v-lazy="'http://localhost:3000/img/head/akari.jpg'" />
        </a>
      </div>
      <div class="item">
        <a href="/login">登录</a>
    ...
    <div>
      <a href="https://github.com/Mubens/stress-free-tv" class="refrence"
        >GitHub</a
      >
    </div>
  </div>
...
export default {
  ...
  components: {
    HistoryTool: () => import('../History/history-tool')
  }
}
</script>
