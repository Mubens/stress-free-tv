...
<script>
import FormBox from '../components/register-page/form-box'
import FormItem from '../components/register-page/form-item'
import FormInput from '../components/register-page/form-input'
